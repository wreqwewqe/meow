    ...
    const columns = [
        {
            ...
            render: (text) => (<div className='font-bold text-[1.6rem] flex items-center' >
                <Image src={findIcon(text[0])} width={45}></Image>
        ...
        {
            title: <div className=' text-[#c8cad3] text-[1.2rem] relative bottom-[-1rem]  text-center' text-center>Total supplied</div>,
        ...
        {
            title: <div className=' text-[#c8cad3] text-[1.2rem] relative bottom-[-1rem] text-center'>Borrow APY,stable</div>,
            dataIndex: 'stable',
            key: 'stable',
            render: (text) => (<div className='font-bold text-[1.6rem] text-center'>{text}%</div>)
        },
        {
            ...
            render: (text, record) => (<div className='flex font-semibold '>
                ...
                <Button className='text-[1.4rem] py-[0.5rem] px-[1rem] rounded-[0.6rem] border border-solid border-[#EAEBF0] cursor-pointer flex items-center justify-center' onClick={() => router.push('/Details?asset=' + record.asset[0] + '&&net=Ethereum')}>Details</Button>
            </div>)
        }
    ];
    return (
