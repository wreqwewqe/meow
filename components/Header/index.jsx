        ...
        </div>
        {
            show ?
                <div className='w-[100%] bg-[white]  relative z-40'>
                    ...
                    <div className={yshow ? " p-[16px] font-bold text-[15px] boredr border-solid border-[transparent] border-b-[#EAEBF0] cursor-pointer" : "hidden"} onClick={() => { router.push("/EthMarket"); setShow(false) }}>Eth Market</div>
