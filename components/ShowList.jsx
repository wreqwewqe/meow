...
export default function ShowList({ title, about_me, data, columns }) {
    ...
    return (
        <div className='box-border w-[592px] py-[24px] px-[32px] border border-solid border-[#b0b6bd] rounded-[5px]'>
            ...
            {data.length > 0 ? <div className='w-[526px]  rounded-[1px] border border-solid border-[#b0b6bd] mt-[8px] ' >
